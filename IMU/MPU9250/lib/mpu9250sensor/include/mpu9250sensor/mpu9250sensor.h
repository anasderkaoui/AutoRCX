...
class MPU9250Sensor {
 ...
 private:
  ...
  int readDlpfConfig();
  mutable double mag_x_ = 0, mag_y_ = 0, mag_z_ = 0;
  ...
  static constexpr int MAGN_ST1 = 0x02; // Status 1: data ready
  ...
  static constexpr int MAGN_ST2 = 0x09; // Status 2: overflow, data valid
