...
**In [this package](https://github.com/anasderkaoui/AutoRCX/tree/main/IMU/MPU6050) we publish IMU data in order to visualize MPU6050 on RVIZ2 using ROS 2 Foxy if you do not need/have a microcontroller (micro-ros)!**
